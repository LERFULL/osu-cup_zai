...
//
// Лежит в общей библиотеке, а не рядом с экраном турнира, потому что ту же
// сетку рисует эфир. Две раскладки означали бы две сетки, которые однажды
// разойдутся, — а сетка в эфире должна быть той же самой, что в приложении.
// Чистая функция без React: страница зрителя из неё ничего лишнего не тянет.
