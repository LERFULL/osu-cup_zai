...
export const SCENES: SceneMeta[] = [
  ...
  meta({
    id: 'firstBanDraw',
    kind: 'match',
    title: 'Жеребьёвка бана',
    about: 'Бегущая подсветка останавливается на том, кто банит первым',
    timing: 'fixed',
    min: 4,
    max: 6,
    repeatable: true,
  ...
  meta({
    ...
    kind: 'match',
    title: 'Матчпоинт',
    about: 'Кому осталась одна победа',
    timing: 'fixed',
    min: 3,
    max: 4,
    repeatable: true,
  ...
  meta({
    id: 'decider',
    kind: 'match',
    title: 'Решающая карта',
    about: 'Тайбрейк открылся или счёт равный — до победы одна карта',
    timing: 'fixed',
    min: 4,
    max: 5,
    repeatable: true,
  ...
  meta({
    ...
    kind: 'pause',
    title: 'Маппул',
    about: 'Маппул следующего матча по мод-тегам, с превью-аудио',
    timing: 'fixed',
    min: 20,
    max: 40,
    repeatable: false,
  ...
  meta({
    ...
    about: 'Как эти двое играли раньше и какие карты любят',
    timing: 'fixed',
    min: 10,
    max: 14,
    repeatable: false,
  ...
  meta({
    ...
    kind: 'pause',
    title: 'Путь по сетке',
    about: 'Кого игрок прошёл и с каким счётом',
    timing: 'fixed',
    min: 8,
    max: 12,
    repeatable: false,
  ...
  meta({
    id: 'modStats',
    kind: 'pause',
    title: 'Разбор по модам',
    about: 'Какой мод чаще всех банят и на каком больше разгромов',
    timing: 'fixed',
    min: 10,
    max: 14,
    repeatable: true,
  ...
  meta({
    ...
    kind: 'pause',
    title: 'Что разыграли',
    about: 'Карты турнира с числом сыгранных и забаненных раз',
    timing: 'fixed',
    min: 12,
    max: 16,
    repeatable: true,
  ...
  meta({
    id: 'clip',
    kind: 'pause',
    title: 'Свой видеофайл',
    about: 'Подложенный реплей или нарезка. Только локально и в OBS',
    timing: 'data',
    min: 0,
    max: 0,
    repeatable: false,
