// Общее у пульта и мини-пульта.
//
// Одно и то же управление живёт в двух местах: в разделе «Эфир» целиком и
// закреплённой панелью на любом другом экране. Горячие клавиши и отсчёт кадра
// поэтому здесь, а не в одном из них: разойдись они — и пробел на экране
// турнира делал бы не то же, что пробел в пульте.
...
/**
 * Кадры быстрого доступа. Одни и те же в пульте и в мини-пульте: у хоста
 * должно быть одно место, где лежит «вернуть матч», а не два разных.
 */
